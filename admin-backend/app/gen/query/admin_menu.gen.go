...
func newAdminMenu(db *gorm.DB, opts ...gen.DOOption) adminMenu {
	...
	_adminMenu.Key = field.NewString(tableName, "key")
	_adminMenu.Describe = field.NewString(tableName, "describe")
	...
	_adminMenu.IsEnabled = field.NewInt32(tableName, "is_enabled")
...
type adminMenu struct {
	...
	Name                 field.String // 权限中文名称
	Key                  field.String // 菜单的唯一键名
	Describe             field.String // 描述
	Icon                 field.String // 路径图标
	...
	IsEnabled            field.Int32  // 1：启用，0禁用
