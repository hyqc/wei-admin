...
type ReqAccountEdit struct {
	...
	Avatar        string                 `protobuf:"bytes,2,opt,name=avatar,proto3" json:"avatar,omitempty" binding:"omitempty,url" label:"头像地址"`            //头像（非必填） @gotags:  binding:"omitempty,url" label:"头像地址"
...
func (x *ReqAccountPasswordEdit) GetNewPassword() string {
	if x != nil {
...
type AdminInfo struct {
	...
	CurrentLoginIp   string                 `protobuf:"bytes,18,opt,name=currentLoginIp,proto3" json:"currentLoginIp,omitempty"`     // 本次登录IP
	CurrentLoginTime string                 `protobuf:"bytes,19,opt,name=currentLoginTime,proto3" json:"currentLoginTime,omitempty"` // 本次登录时间
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *AdminInfo) GetCurrentLoginIp() string {
	if x != nil {
...
func (x *AdminInfo) GetCurrentLoginTime() string {
	if x != nil {
...
const file_admin_account_proto_rawDesc = "" +
	...
	"\x13RespAccountEditData\"\x86\x01\n" +
	...
	"\x19RespAccountPermissionData\"\xa6\x06\n" +
	"\tAdminInfo\x12\x18\n" +
	...
	"\x05roles\x18\x11 \x03(\v2\x18.admin.AdminUserRoleItemR\x05roles\x12&\n" +
	"\x0ecurrentLoginIp\x18\x12 \x01(\tR\x0ecurrentLoginIp\x12*\n" +
	"\x10currentLoginTime\x18\x13 \x01(\tR\x10currentLoginTime\x1aI\n" +
	"\n" +
	"MenusEntry\x12\x10\n" +
