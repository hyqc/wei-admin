...
func file_admin_account_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_admin_account_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RespAccountInfoData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_admin_account_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RespAccountEditData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_admin_account_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RespAccountPasswordEditData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_admin_account_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*RespAccountPermissionData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_admin_account_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
