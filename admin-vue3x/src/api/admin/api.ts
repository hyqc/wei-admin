...
/** 接口列表 */
export const getAdminApiList = (body: ReqAdminApiList) =>
  post<ResponseAdminApiListType>('/admin/api/list', body);

/** 接口详情 */
export const getAdminApiInfo = (body: ReqAdminApiInfo) =>
  post<AdminApiItem>('/admin/api/info', body);
