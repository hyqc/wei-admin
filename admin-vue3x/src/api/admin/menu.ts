...
/** 菜单树 */
export const getAdminMenuTree = () =>
  post<ResponseAdminMenuTreeType>('/admin/menu/tree', {});

/** 菜单列表 */
export const getAdminMenuList = (body: ReqAdminMenuList) =>
  post<{ list: MenuTreeItem[] }>('/admin/menu/list', body);

/** 菜单详情 */
export const getAdminMenuInfo = (body: ReqAdminMenuInfo) =>
  post<AdminMenuModel>('/admin/menu/info', body);
...
/** 页面模块权限列表 */
export const getAdminMenuMode = (body: ReqAdminMenuMode) =>
  post<ResponseAdminMenuModeType>('/admin/menu/modes', body);
