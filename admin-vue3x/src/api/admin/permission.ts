...
/** 创建权限 */
export const addAdminPermission = (body: ReqAdminPermissionAdd) =>
  post<null>('/admin/permission/add', body);
...
/** 修改权限 */
export const editAdminPermission = (body: ReqAdminPermissionEdit) =>
  post<null>('/admin/permission/edit', body);

/** 删除权限 */
export const deleteAdminPermission = (body: { id?: number }) =>
  post<null>('/admin/permission/delete', body);
