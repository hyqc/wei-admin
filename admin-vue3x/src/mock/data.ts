...
export const apiData: AdminApiItem[] = [
  { id: 1, key: 'adminUser::list', name: '账号列表', path: '/admin/user/list', describe: '账号列表', isEnabled: false },
  { id: 2, key: 'adminUser::add', name: '账号创建', path: '/admin/user/add', describe: '账号创建', isEnabled: true },
  { id: 3, key: 'adminUser::detail', name: '账号详情', path: '/admin/user/detail', describe: '账号详情', isEnabled: true },
  ...
  { id: 7, key: 'adminUser::bindRoles', name: '账号绑定角色', path: '/admin/user/bindRoles', describe: '账号绑定角色', isEnabled: true },
  ...
  { id: 10, key: 'adminRole::detail', name: '角色详情', path: '/admin/role/detail', describe: '', isEnabled: true },
  ...
  { id: 14, key: 'adminRole::bindPermissions', name: '角色绑定权限', path: '/admin/role/bindPermissions', describe: '', isEnabled: true },
  ...
  { id: 19, key: 'adminMenu::detail', name: '菜单详情', path: '/admin/menu/detail', describe: '', isEnabled: true },
  ...
  { id: 27, key: 'adminPermission::detail', name: '权限详情', path: '/admin/permission/detail', describe: '', isEnabled: true },
  ...
  { id: 31, key: 'adminPermission::addMenuPermissions', name: '权限指定菜单批量创建权限', path: '/admin/permission/addMenuPermissions', describe: '给指定的菜单创建查看，编辑，删除权限', isEnabled: true },
  { id: 32, key: 'adminPermission::bindApis', name: '权限绑定接口', path: '/admin/permission/bindApis', describe: '', isEnabled: true },
  ...
  { id: 35, key: 'adminApi::detail', name: '接口详情', path: '/admin/api/detail', describe: '', isEnabled: true },
  ...
  { id: 41, key: 'adminMenu::mode', name: '菜单页面权限列表', path: '/admin/menu/mode', describe: '', isEnabled: true },
];
...
export const permissionData: MockPermission[] = [
  { id: 1, menuId: 2, menuName: '账号管理', menuPath: '/admin/user', key: 'AdminUserView', name: '账号查看', type: 'view', typeText: '查看', describe: '账号管理查看', enabled: true, apiIds: [1, 3, 40] },
  { id: 2, menuId: 2, menuName: '账号管理', menuPath: '/admin/user', key: 'AdminUserEdit', name: '账号编辑', type: 'edit', typeText: '编辑', describe: '账号管理编辑', enabled: true, apiIds: [2, 4, 5, 7] },
  { id: 3, menuId: 2, menuName: '账号管理', menuPath: '/admin/user', key: 'AdminUserDelete', name: '账号删除', type: 'delete', typeText: '删除', describe: '账号管理删除', enabled: true, apiIds: [6] },
  { id: 4, menuId: 3, menuName: '角色管理', menuPath: '/admin/role', key: 'AdminRoleView', name: '角色查看', type: 'view', typeText: '查看', describe: '角色管理查看', enabled: true, apiIds: [8, 10, 15, 40, 41] },
  { id: 5, menuId: 3, menuName: '角色管理', menuPath: '/admin/role', key: 'AdminRoleEdit', name: '角色编辑', type: 'edit', typeText: '编辑', describe: '角色管理编辑', enabled: true, apiIds: [9, 11, 12, 14] },
  { id: 6, menuId: 3, menuName: '角色管理', menuPath: '/admin/role', key: 'AdminRoleDelete', name: '角色删除', type: 'delete', typeText: '删除', describe: '角色管理删除', enabled: true, apiIds: [13] },
  { id: 7, menuId: 4, menuName: '菜单管理', menuPath: '/admin/menu', key: 'AdminMenuView', name: '菜单查看', type: 'view', typeText: '查看', describe: '菜单管理查看', enabled: true, apiIds: [16, 17, 19, 23, 24, 41] },
  { id: 8, menuId: 4, menuName: '菜单管理', menuPath: '/admin/menu', key: 'AdminMenuEdit', name: '菜单编辑', type: 'edit', typeText: '编辑', describe: '菜单管理编辑', enabled: true, apiIds: [18, 20, 21, 31] },
  { id: 9, menuId: 4, menuName: '菜单管理', menuPath: '/admin/menu', key: 'AdminMenuDelete', name: '菜单删除', type: 'delete', typeText: '删除', describe: '菜单管理删除', enabled: true, apiIds: [22] },
  { id: 10, menuId: 5, menuName: '权限管理', menuPath: '/admin/permission', key: 'AdminPermissionView', name: '权限查看', type: 'view', typeText: '查看', describe: '权限管理查看', enabled: true, apiIds: [25, 27] },
  { id: 11, menuId: 5, menuName: '权限管理', menuPath: '/admin/permission', key: 'AdminPermissionEdit', name: '权限编辑', type: 'edit', typeText: '编辑', describe: '权限管理编辑', enabled: true, apiIds: [26, 28, 29, 32] },
  { id: 12, menuId: 5, menuName: '权限管理', menuPath: '/admin/permission', key: 'AdminPermissionDelete', name: '权限删除', type: 'delete', typeText: '删除', describe: '权限管理删除', enabled: true, apiIds: [30] },
  { id: 13, menuId: 6, menuName: '接口管理', menuPath: '/admin/api', key: 'AdminApiView', name: '接口查看', type: 'view', typeText: '查看', describe: '接口管理查看', enabled: true, apiIds: [33, 35, 39] },
  { id: 14, menuId: 6, menuName: '接口管理', menuPath: '/admin/api', key: 'AdminApiEdit', name: '接口编辑', type: 'edit', typeText: '编辑', describe: '接口管理编辑', enabled: true, apiIds: [34, 36, 37] },
  { id: 15, menuId: 6, menuName: '接口管理', menuPath: '/admin/api', key: 'AdminApiDelete', name: '接口删除', type: 'delete', typeText: '删除', describe: '接口管理删除', enabled: true, apiIds: [38] },
];
