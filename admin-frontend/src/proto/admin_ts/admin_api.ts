...
export class ApiListResp extends pb_1.Message {
    ...
    set list(value: ApiItem[]) {
        pb_1.Message.setRepeatedWrapperField(this, 2, value);
    }
    static fromObject(data: {
        total?: number;
        list?: ReturnType<typeof ApiItem.prototype.toObject>[];
    }): ApiListResp {
        ...
        if (data.list != null) {
            message.list = data.list.map(item => ApiItem.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.list != null) {
            data.list = this.list.map((item: ApiItem) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.list.length)
            writer.writeRepeatedMessage(2, this.list, (item: ApiItem) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                case 1:
                    ...
                    break;
                case 2:
                    reader.readMessage(message.list, () => pb_1.Message.addToRepeatedWrapperField(message, 2, ApiItem.deserialize(reader), ApiItem));
                    break;
                default: reader.skipField();
            }
        }
