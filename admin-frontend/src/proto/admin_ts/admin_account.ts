...
export class ReqLogin extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqLogin {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqLogin();
    ...
    static deserializeBinary(bytes: Uint8Array): ReqLogin {
        return ReqLogin.deserialize(bytes);
    }
}
export class RespLoginData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        data?: AdminInfo;
    }) {
    ...
    get data() {
        return pb_1.Message.getWrapperField(this, AdminInfo, 2) as AdminInfo;
    }
    set data(value: AdminInfo) {
    ...
    static fromObject(data: {
        data?: ReturnType<typeof AdminInfo.prototype.toObject>;
    }): RespLoginData {
        const message = new RespLoginData({});
        if (data.data != null) {
            message.data = AdminInfo.fromObject(data.data);
        }
        return message;
    }
    toObject() {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RespLoginData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RespLoginData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                case 2:
                    reader.readMessage(message.data, () => message.data = AdminInfo.deserialize(reader));
                    break;
                default: reader.skipField();
            }
        }
    ...
    static deserializeBinary(bytes: Uint8Array): RespLoginData {
        return RespLoginData.deserialize(bytes);
    }
}
export class ReqAccountInfo extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
    ...
    static fromObject(data: {
        ...
        const message = new ReqAccountInfo({});
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqAccountInfo {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqAccountInfo();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): ReqAccountInfo {
        return ReqAccountInfo.deserialize(bytes);
    }
}
export class RespAccountInfoData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        data?: AdminInfo;
    }) {
    ...
    static fromObject(data: {
        ...
        const message = new RespAccountInfoData({});
        if (data.data != null) {
            message.data = AdminInfo.fromObject(data.data);
        }
        return message;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RespAccountInfoData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RespAccountInfoData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RespAccountInfoData {
        return RespAccountInfoData.deserialize(bytes);
    }
}
export class ReqAccountEdit extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        nickname?: string;
        avatar?: string;
    ...
    static fromObject(data: {
        ...
        const message = new ReqAccountEdit({});
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqAccountEdit {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqAccountEdit();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): ReqAccountEdit {
        return ReqAccountEdit.deserialize(bytes);
    }
}
export class RespAccountEditData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {}) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    static fromObject(data: {}): RespAccountEditData {
        const message = new RespAccountEditData({});
        return message;
    }
    toObject() {
        const data: {} = {};
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RespAccountEditData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RespAccountEditData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RespAccountEditData {
        return RespAccountEditData.deserialize(bytes);
    }
}
export class ReqAccountPasswordEdit extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        oldPassword?: string;
        password?: string;
    ...
    static fromObject(data: {
        ...
        const message = new ReqAccountPasswordEdit({});
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqAccountPasswordEdit {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqAccountPasswordEdit();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): ReqAccountPasswordEdit {
        return ReqAccountPasswordEdit.deserialize(bytes);
    }
}
export class RespAccountPasswordEditData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {}) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    static fromObject(data: {}): RespAccountPasswordEditData {
        const message = new RespAccountPasswordEditData({});
        return message;
    }
    toObject() {
        const data: {} = {};
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RespAccountPasswordEditData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RespAccountPasswordEditData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RespAccountPasswordEditData {
        return RespAccountPasswordEditData.deserialize(bytes);
    }
}
export class ReqAccountPermission extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        menuId?: number;
    }) {
    ...
    static fromObject(data: {
        menuId?: number;
    }): ReqAccountPermission {
        const message = new ReqAccountPermission({});
        if (data.menuId != null) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqAccountPermission {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqAccountPermission();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): ReqAccountPermission {
        return ReqAccountPermission.deserialize(bytes);
    }
}
export class RespAccountPermissionData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {}) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    static fromObject(data: {}): RespAccountPermissionData {
        const message = new RespAccountPermissionData({});
        return message;
    }
    toObject() {
        const data: {} = {};
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RespAccountPermissionData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RespAccountPermissionData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RespAccountPermissionData {
        return RespAccountPermissionData.deserialize(bytes);
    }
}
export class AdminInfo extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.expire != 0)
            writer.writeInt64(13, this.expire);
