...
export class ReqMenuList extends pb_1.Message {
    #one_of_decls: number[][] = [];
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqMenuList {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqMenuList();
    ...
    static deserializeBinary(bytes: Uint8Array): ReqMenuList {
        return ReqMenuList.deserialize(bytes);
    }
}
export class RespMenuListData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        total?: number;
        list?: MenuItem[];
    ...
    static fromObject(data: {
        total?: number;
        list?: ReturnType<typeof MenuItem.prototype.toObject>[];
    }): RespMenuListData {
        const message = new RespMenuListData({});
        if (data.total != null) {
            message.total = data.total;
        }
        if (data.list != null) {
            message.list = data.list.map(item => MenuItem.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.list != null) {
            data.list = this.list.map((item: MenuItem) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.list.length)
            writer.writeRepeatedMessage(2, this.list, (item: MenuItem) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RespMenuListData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RespMenuListData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                case 1:
                    ...
                    break;
                case 2:
                    reader.readMessage(message.list, () => pb_1.Message.addToRepeatedWrapperField(message, 2, MenuItem.deserialize(reader), MenuItem));
                    break;
                default: reader.skipField();
            }
        }
    ...
    static deserializeBinary(bytes: Uint8Array): RespMenuListData {
        return RespMenuListData.deserialize(bytes);
    }
}
export class ReqMenuAdd extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        key?: string;
        path?: string;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqMenuAdd {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqMenuAdd();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): ReqMenuAdd {
        return ReqMenuAdd.deserialize(bytes);
    }
}
export class RespMenuAddData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {}) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    static fromObject(data: {}): RespMenuAddData {
        const message = new RespMenuAddData({});
        return message;
    }
    toObject() {
        const data: {} = {};
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RespMenuAddData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RespMenuAddData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RespMenuAddData {
        return RespMenuAddData.deserialize(bytes);
    }
}
export class ReqMenuInfo extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        menuId?: number;
    }) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqMenuInfo {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqMenuInfo();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): ReqMenuInfo {
        return ReqMenuInfo.deserialize(bytes);
    }
}
export class RespMenuInfoData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        data?: MenuItem;
    }) {
    ...
    get data() {
        return pb_1.Message.getWrapperField(this, MenuItem, 1) as MenuItem;
    }
    ...
    static fromObject(data: {
        data?: ReturnType<typeof MenuItem.prototype.toObject>;
    }): RespMenuInfoData {
        const message = new RespMenuInfoData({});
        if (data.data != null) {
            message.data = MenuItem.fromObject(data.data);
        }
        return message;
    }
    toObject() {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RespMenuInfoData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RespMenuInfoData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                case 1:
                    reader.readMessage(message.data, () => message.data = MenuItem.deserialize(reader));
                    break;
                default: reader.skipField();
            }
        }
    ...
    static deserializeBinary(bytes: Uint8Array): RespMenuInfoData {
        return RespMenuInfoData.deserialize(bytes);
    }
}
export class ReqMenuEdit extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        menuId?: number;
        key?: string;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqMenuEdit {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqMenuEdit();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): ReqMenuEdit {
        return ReqMenuEdit.deserialize(bytes);
    }
}
export class RespMenuEditData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {}) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    static fromObject(data: {}): RespMenuEditData {
        const message = new RespMenuEditData({});
        return message;
    }
    toObject() {
        const data: {} = {};
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RespMenuEditData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RespMenuEditData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RespMenuEditData {
        return RespMenuEditData.deserialize(bytes);
    }
}
export class ReqMenuEnable extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        menuId?: number;
        enabled?: boolean;
    ...
    static fromObject(data: {
        ...
        const message = new ReqMenuEnable({});
        if (data.menuId != null) {
            message.menuId = data.menuId;
        }
        if (data.enabled != null) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqMenuEnable {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqMenuEnable();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): ReqMenuEnable {
        return ReqMenuEnable.deserialize(bytes);
    }
}
export class RespMenuEnableData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {}) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    static fromObject(data: {}): RespMenuEnableData {
        const message = new RespMenuEnableData({});
        return message;
    }
    toObject() {
        const data: {} = {};
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RespMenuEnableData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RespMenuEnableData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RespMenuEnableData {
        return RespMenuEnableData.deserialize(bytes);
    }
}
export class ReqMenuDelete extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        menuId?: number;
    }) {
    ...
    static fromObject(data: {
        ...
        const message = new ReqMenuDelete({});
        if (data.menuId != null) {
            message.menuId = data.menuId;
        }
        return message;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqMenuDelete {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqMenuDelete();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): ReqMenuDelete {
        return ReqMenuDelete.deserialize(bytes);
    }
}
export class RespMenuDeleteData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {}) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    static fromObject(data: {}): RespMenuDeleteData {
        const message = new RespMenuDeleteData({});
        return message;
    }
    toObject() {
        const data: {} = {};
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RespMenuDeleteData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RespMenuDeleteData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RespMenuDeleteData {
        return RespMenuDeleteData.deserialize(bytes);
    }
}
export class ReqMenuPermissions extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        menuId?: number;
    }) {
    ...
    static fromObject(data: {
        ...
        const message = new ReqMenuPermissions({});
        if (data.menuId != null) {
            message.menuId = data.menuId;
        }
        return message;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqMenuPermissions {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqMenuPermissions();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): ReqMenuPermissions {
        return ReqMenuPermissions.deserialize(bytes);
    }
}
export class RespMenuPermissionsData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
    ...
    get list() {
        return pb_1.Message.getRepeatedWrapperField(this, MenuPermissions, 1) as MenuPermissions[];
    }
    set list(value: MenuPermissions[]) {
        pb_1.Message.setRepeatedWrapperField(this, 1, value);
    }
    static fromObject(data: {
        list?: ReturnType<typeof MenuPermissions.prototype.toObject>[];
    }): RespMenuPermissionsData {
        const message = new RespMenuPermissionsData({});
        if (data.list != null) {
            message.list = data.list.map(item => MenuPermissions.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.list != null) {
            data.list = this.list.map((item: MenuPermissions) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.list.length)
            writer.writeRepeatedMessage(1, this.list, (item: MenuPermissions) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RespMenuPermissionsData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RespMenuPermissionsData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                case 1:
                    reader.readMessage(message.list, () => pb_1.Message.addToRepeatedWrapperField(message, 1, MenuPermissions.deserialize(reader), MenuPermissions));
                    break;
                default: reader.skipField();
            }
        }
    ...
    static deserializeBinary(bytes: Uint8Array): RespMenuPermissionsData {
        return RespMenuPermissionsData.deserialize(bytes);
    }
}
export class ReqMenuPages extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        all?: boolean;
    }) {
    ...
    static fromObject(data: {
        ...
        const message = new ReqMenuPages({});
        if (data.all != null) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqMenuPages {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqMenuPages();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): ReqMenuPages {
        return ReqMenuPages.deserialize(bytes);
    }
}
export class ReqMenuMode extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {}) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    static fromObject(data: {}): ReqMenuMode {
        const message = new ReqMenuMode({});
        return message;
    }
    toObject() {
        const data: {} = {};
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): ReqMenuMode {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new ReqMenuMode();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): ReqMenuMode {
        return ReqMenuMode.deserialize(bytes);
    }
}
export class MenuItem extends pb_1.Message {
    ...
    get routes() {
        return pb_1.Message.getRepeatedWrapperField(this, MenuItem, 9) as MenuItem[];
    }
    set routes(value: MenuItem[]) {
    ...
    static fromObject(data: {
        ...
        hideInMenu?: boolean;
        hideChildrenInMenu?: boolean;
        routes?: ReturnType<typeof MenuItem.prototype.toObject>[];
    }): MenuItem {
        ...
        if (data.routes != null) {
            message.routes = data.routes.map(item => MenuItem.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.routes != null) {
            data.routes = this.routes.map((item: MenuItem) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.hideInMenu != false)
            writer.writeBool(7, this.hideInMenu);
        if (this.hideChildrenInMenu != false)
            writer.writeBool(8, this.hideChildrenInMenu);
        if (this.routes.length)
            writer.writeRepeatedMessage(9, this.routes, (item: MenuItem) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    reader.readMessage(message.routes, () => pb_1.Message.addToRepeatedWrapperField(message, 9, MenuItem.deserialize(reader), MenuItem));
                    break;
                default: reader.skipField();
            }
        }
