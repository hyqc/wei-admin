...
export class MenuItem extends pb_1.Message {
    ...
    get routes() {
        return pb_1.Message.getRepeatedWrapperField(this, RouteItem, 9) as RouteItem[];
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.routes.length)
            writer.writeRepeatedMessage(9, this.routes, (item: RouteItem) => item.serialize(writer));
        if (!w)
        ...
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    reader.readMessage(message.routes, () => pb_1.Message.addToRepeatedWrapperField(message, 9, RouteItem.deserialize(reader), RouteItem));
                    break;
