...
export class RoleListReq extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RoleListReq {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RoleListReq();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RoleListReq {
        return RoleListReq.deserialize(bytes);
    }
}
export class RoleListRespData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        total?: number;
        rows?: RoleItem[];
    ...
    set rows(value: RoleItem[]) {
        pb_1.Message.setRepeatedWrapperField(this, 2, value);
    }
    static fromObject(data: {
        total?: number;
        rows?: ReturnType<typeof RoleItem.prototype.toObject>[];
    }): RoleListRespData {
        const message = new RoleListRespData({});
        if (data.total != null) {
            message.total = data.total;
        }
        if (data.rows != null) {
            message.rows = data.rows.map(item => RoleItem.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.rows != null) {
            data.rows = this.rows.map((item: RoleItem) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.rows.length)
            writer.writeRepeatedMessage(2, this.rows, (item: RoleItem) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RoleListRespData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RoleListRespData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                case 1:
                    ...
                    break;
                case 2:
                    reader.readMessage(message.rows, () => pb_1.Message.addToRepeatedWrapperField(message, 2, RoleItem.deserialize(reader), RoleItem));
                    break;
                default: reader.skipField();
            }
        }
    ...
    static deserializeBinary(bytes: Uint8Array): RoleListRespData {
        return RoleListRespData.deserialize(bytes);
    }
}
export class RoleAllReq extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        id?: number;
        name?: string;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RoleAllReq {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RoleAllReq();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RoleAllReq {
        return RoleAllReq.deserialize(bytes);
    }
}
export class RoleAllResp extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {}) {
        super();
        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
    ...
    static fromObject(data: {}): RoleAllResp {
        const message = new RoleAllResp({});
        return message;
    }
    toObject() {
        const data: {} = {};
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RoleAllResp {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RoleAllResp();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RoleAllResp {
        return RoleAllResp.deserialize(bytes);
    }
}
export class RoleAddReq extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        name?: string;
        describe?: string;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RoleAddReq {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RoleAddReq();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RoleAddReq {
        return RoleAddReq.deserialize(bytes);
    }
}
...
export class RoleInfoReq extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        id?: number;
    }) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RoleInfoReq {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RoleInfoReq();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RoleInfoReq {
        return RoleInfoReq.deserialize(bytes);
    }
}
export class RoleInfoRespData extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        id?: number;
        name?: string;
    ...
    static fromObject(data: {
        ...
        const message = new RoleInfoRespData({});
        if (data.id != null) {
            message.id = data.id;
        }
        if (data.name != null) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RoleInfoRespData {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RoleInfoRespData();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RoleInfoRespData {
        return RoleInfoRespData.deserialize(bytes);
    }
}
export class RoleEditReq extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        id?: number;
        name?: string;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RoleEditReq {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RoleEditReq();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RoleEditReq {
        return RoleEditReq.deserialize(bytes);
    }
}
export class RoleEnableReq extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        id?: number;
        enabled?: boolean;
    ...
    static fromObject(data: {
        ...
        const message = new RoleEnableReq({});
        if (data.id != null) {
            message.id = data.id;
        }
        if (data.enabled != null) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RoleEnableReq {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RoleEnableReq();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RoleEnableReq {
        return RoleEnableReq.deserialize(bytes);
    }
}
export class RoleDeleteReq extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        id?: number;
    ...
    static fromObject(data: {
        ...
        const message = new RoleDeleteReq({});
        if (data.id != null) {
            message.id = data.id;
        }
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RoleDeleteReq {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RoleDeleteReq();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RoleDeleteReq {
        return RoleDeleteReq.deserialize(bytes);
    }
}
export class RoleBindPermissionsReq extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        id?: number;
        permissionIds?: number[];
    ...
    static fromObject(data: {
        id?: number;
        permissionIds?: number[];
    }): RoleBindPermissionsReq {
        const message = new RoleBindPermissionsReq({});
        if (data.id != null) {
            message.id = data.id;
        }
        if (data.permissionIds != null) {
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RoleBindPermissionsReq {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RoleBindPermissionsReq();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RoleBindPermissionsReq {
        return RoleBindPermissionsReq.deserialize(bytes);
    }
}
...
export class RolePermissionsReq extends pb_1.Message {
    #one_of_decls: number[][] = [];
    constructor(data?: any[] | {
        id?: number;
    }) {
    ...
    static fromObject(data: {
        ...
        const message = new RolePermissionsReq({});
        if (data.id != null) {
            message.id = data.id;
        }
        return message;
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): RolePermissionsReq {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new RolePermissionsReq();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): RolePermissionsReq {
        return RolePermissionsReq.deserialize(bytes);
    }
}
