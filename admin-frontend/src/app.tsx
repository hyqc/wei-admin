...
import { GetLoginToken, HandleMenusToMap, HandleRemoteMenuIntoLocal, IsLogin, IsLoginPage, Logout, MenusMapType } from './utils/common';
import { AdminInfo, RespAccountInfoData } from './proto/admin_ts/admin_account';
