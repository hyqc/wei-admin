...
/** 账号列表 */
export const getAdminUserList = (body: ReqAdminUserList) => post<ResponseAdminUserListType>('/admin/user/list', body);

/** 账号详情 */
export const getAdminUserInfo = (body: ReqAdminUserInfo) => post<ResponseAdminUserInfoType>('/admin/user/info', body);
...
/** 账号绑定角色 */
export const bindAdminUserRoles = (body: ReqAdminUserBindRoles) => post<null>('/admin/user/bind_roles', body);
