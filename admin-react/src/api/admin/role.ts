...
/** 角色列表 */
export const getAdminRoleList = (body: ReqAdminRoleList) => post<ResponseAdminRoleListType>('/admin/role/list', body);

/** 角色详情 */
export const getAdminRoleInfo = (body: ReqAdminRoleInfo) => post<ResponseAdminRoleInfoType>('/admin/role/info', body);
...
/** 全部角色列表 */
export const getAdminRoleAll = (body?: { name?: string }) => post<RoleItem[]>('/admin/role/all', body || {});
